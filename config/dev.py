...
if not load_dotenv(join(BASE_DIR, "config/dev.env")):
    raise Exception("Failed to load environment variables from dev.env file")

if APP_USES_DATABASE:
    DB_HOSTNAME = os.environ.get("DB_HOSTNAME", "localhost")
    DB_PORT = os.environ.get("DB_PORT", "5432")
    DB_NAME = os.environ.get("DB_NAME", "miniblog")
...
print("--=== Development environment configuration loaded successfully. ===--")
